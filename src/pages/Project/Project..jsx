    ...
    <div className="project-container">
      <div className="project">
        ...
        <div className="project-links">
          <a
            href="https://github.com/yanacavalian/yogo-website"
            target="_blank"
          ...
          <a
            href="https://yanacavalian.github.io/yogo-website/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Demo
      ...
      <div className="project">
        ...
        <div className="project-links">
          <a
            href="https://github.com/YanaCavalian/Calculator"
            target="_blank"
            rel="noopener noreferrer"
          >
            GitHub Repository
          ...
          <a
            href="https://yanacavalian.github.io/Calculator/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Demo
